...
% Axes
\draw[->,line width=0.7, black] (-1.4,0)--(1.9,0) node[right]{$x$};
\draw[->,line width=0.7, black] (0,-1.4)--(0,1.8) node[above]{$y$};

% Vectors and dashed lines
\draw[arrows=->, line width=1.2, black] (0,0)--(1.5,1.5);
...
\node[color=black] at (1.1,-0.2) {$1$};
\node[color=black] at (-1.15,-0.2) {$-1$};
\node[color=black] at (-0.2,1.1) {$1$};
\node[color=black] at (-0.25,-1.12) {$-1$};
